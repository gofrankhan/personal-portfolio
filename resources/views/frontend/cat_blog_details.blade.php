...
<section class="standard__blog">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                @foreach($blogpost as $blpost)
                <div class="standard__blog__post">
                    <div class="standard__blog__thumb">
                        <a href="{{ route('blog.details', $blpost->id)}}"><img src="{{ asset($blpost->blog_image)}}" alt=""></a>
                        <a href="{{ route('blog.details', $blpost->id)}}" class="blog__link"><i class="far fa-long-arrow-right"></i></a>
                    </div>
                    <div class="standard__blog__content">
                        ...
                        <h2 class="title"><a href="{{ route('blog.details', $blpost->id)}}">{{ $blpost->blog_title }}</a></h2>
                        <p>{{ Str::limit( $blpost->blog_description, 500) }}</p>
                        <ul class="blog__post__meta">
                            <li><i class="fal fa-calendar-alt"></i> {{ Carbon\Carbon::parse($blpost->updated_at)->diffForHumans() }}</li>
                        ...
                        <ul class="rc__post">
                            ...
                            <li class="rc__post__item">
                                ...
                                <div class="rc__post__content">
                                    ...
                                    <span class="post-date"><i class="fal fa-calendar-alt"></i> {{ Carbon\Carbon::parse($blg->updated_at)->diffForHumans() }}</span>
                                </div>
                            </li>
                            @endforeach                                                                                             
                        </ul>
