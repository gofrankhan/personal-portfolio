 ...
 <main>
            ...
            <section class="breadcrumb__wrap">
                ...
                <div class="breadcrumb__wrap__icon">
                    <ul>
                        <li><img src="{{ asset('/upload/multi/bat_1.png') }}" alt=""></li>
                        <li><img src="{{ asset('/upload/multi/100_1.png') }}" alt=""></li>
                        <li><img src="{{ asset('/upload/multi/ball_1.png') }}" alt=""></li>
                        <li><img src="{{ asset('/upload/multi/stamp_1.png') }}" alt=""></li>
                        <li><img src="{{ asset('/upload/multi/stadium_1.png') }}" alt=""></li>
                        <li><img src="{{ asset('/upload/multi/cup_1.png') }}" alt=""></li>
                    </ul>
                </div>
            </section>
            <!-- breadcrumb-area-end -->
