            ...
            <div class="card">
                ...
                <form method="post" action="{{ route('store.blogs') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="blog_title" type="text" id="blog_title" value="">
                            @error('blog_title')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="blog_tags" type="text" id="blog_tags" value="ODI, Test Cricket" data-role="tagsinput">
                            @error('blog_tags')
                                <span class="text-danger"> {{ $message }} </span>
                            @enderror
                        </div>
                    ...
                    <input type="submit"  class="btn btn-primary btn-rounded waves-effect waves-light" value="Insert Blog Data">
                </form>
            </div>
            </div>
        </div>
